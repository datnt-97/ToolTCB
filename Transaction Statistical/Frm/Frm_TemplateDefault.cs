...
namespace Transaction_Statistical
{
    public partial class Frm_TemplateDefault : Form
    {
            ...
            if (isTopPanelDragged)
            {
                ...
                if (this.Location.X > 2 || this.Location.Y > 2)
                {
                    if (this.WindowState == FormWindowState.Maximized)
                    {
                        ...
                        toolTip1.SetToolTip(maxBtnCustom, "Maximize");
                        maxBtnCustom.CFormState = MinMaxButton.CustomFormState.Normal;
        ...
        private void TopPanel_MouseUp(object sender, MouseEventArgs e)
        {
            ...
            if (this.Location.Y <= 5)
            {
                if (!isWindowMaximized)
                {
                    ...
                    toolTip1.SetToolTip(maxBtnCustom, "Restore Down");
                    maxBtnCustom.CFormState = AddOn.MinMaxButton.CustomFormState.Maximize;
        ...
        private void bt_MinButton_Click(object sender, EventArgs e)
        {
        ...
        private void bt_MaxButton_Click(object sender, EventArgs e)
        {
            if (isWindowMaximized)
            {
                this.Location = _normalWindowLocation;
            ...
            else
            {
                ...
                this.Size = new System.Drawing.Size(rect.Width, rect.Height);
                toolTip1.SetToolTip(maxBtnCustom, "Restore Down");
               maxBtnCustom.CFormState = MinMaxButton.CustomFormState.Maximize;
                isWindowMaximized = true;
            }
        }
