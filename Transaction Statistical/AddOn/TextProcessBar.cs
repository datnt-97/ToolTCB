...
namespace Transaction_Statistical
{
    ...
    public class TextProgressBar : ProgressBar
    {
        ...
        private SolidBrush _progressColourBrush = new SolidBrush(Color.FromArgb(20, 120, 240));
        ...
        private void DrawProgressBar(Graphics g)
        {
            ...
            using (SolidBrush fadeBrush = new SolidBrush(this.BackColor))
            {
                g.FillRectangle(new SolidBrush(this.ProgressColor), ClientRectangle);
